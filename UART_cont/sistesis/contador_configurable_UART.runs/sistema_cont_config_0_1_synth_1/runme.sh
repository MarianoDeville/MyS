...
HD_PWD='E:/Facultad/MyS/UART_cont/sistesis/contador_configurable_UART.runs/sistema_cont_config_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_cont_config_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sistema_cont_config_0_1.tcl
