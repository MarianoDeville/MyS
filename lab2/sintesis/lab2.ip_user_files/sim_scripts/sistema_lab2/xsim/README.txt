...
#
# Generated by export_simulation on Tue Nov 11 19:42:06 -0300 2025
#
################################################################################
...
'-reset_run' switch to the './sistema_lab2.sh' script.

./sistema_lab2.sh -reset_run
...
./sistema_lab2.sh -noclean_files

For more information on the script, please type './sistema_lab2.sh -help'.
