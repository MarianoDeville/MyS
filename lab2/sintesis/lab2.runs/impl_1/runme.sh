...
HD_PWD='E:/Facultad/MyS/lab2/sintesis/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_lab2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sistema_lab2_wrapper.tcl -notrace
