...
HD_PWD='E:/Facultad/MyS/lab2/sintesis/lab2.runs/sistema_lab2_vio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_lab2_vio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sistema_lab2_vio_0_0.tcl
