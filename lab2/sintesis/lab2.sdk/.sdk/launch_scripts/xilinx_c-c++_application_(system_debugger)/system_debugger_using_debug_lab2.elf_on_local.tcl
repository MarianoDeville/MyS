...
source E:/Facultad/MyS/lab2/sintesis/lab2.sdk/sistema_lab2_wrapper_hw_platform_0/ps7_init.tcl
targets -set -nocase -filter {name =~"APU*" && jtag_cable_name =~ "Digilent Arty Z7 003017A4C8ABA"} -index 0
loadhw -hw E:/Facultad/MyS/lab2/sintesis/lab2.sdk/sistema_lab2_wrapper_hw_platform_0/system.hdf -mem-ranges [list {0x40000000 0xbfffffff}]
...
rst -processor
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent Arty Z7 003017A4C8ABA"} -index 0
dow E:/Facultad/MyS/lab2/sintesis/lab2.sdk/lab2/Debug/lab2.elf
