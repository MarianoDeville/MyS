...
HD_PWD='E:/Facultad/MyS/Repositorio_ip/cont_config/managed_ip_project/managed_ip_project.runs/cont_config_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cont_config_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cont_config_0.tcl
