...
#
# Generated by export_simulation on Tue Dec 02 17:48:11 -0300 2025
#
################################################################################
...
'-reset_run' switch to the './cont_config_0.sh' script.

./cont_config_0.sh -reset_run
...
./cont_config_0.sh -noclean_files

For more information on the script, please type './cont_config_0.sh -help'.
