...
--               e:/Facultad/MyS/Repositorio_ip/cont_config/cont_config_1/cont_config_1_sim_netlist.vhdl
...
entity cont_config_1_contNb is
  port (
    ...
    desborde_reg_0 : in STD_LOGIC;
    desborde_reg_1 : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of cont_config_1_contNb : entity is "contNb";
end cont_config_1_contNb;

architecture STRUCTURE of cont_config_1_contNb is
  ...
  signal desborde_i_12_n_0 : STD_LOGIC;
  signal desborde_i_13_n_0 : STD_LOGIC;
...
desborde_i_12: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
desborde_i_13: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
desborde_i_8: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
desborde_i_9: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cont_config_1_genEnaNb is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of cont_config_1_genEnaNb : entity is "genEnaNb";
end cont_config_1_genEnaNb;

architecture STRUCTURE of cont_config_1_genEnaNb is
  ...
  attribute SOFT_HLUTNM of desborde_i_4 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of desborde_i_5 : label is "soft_lutpair1";
begin
  ena_gen <= \^ena_gen\;
...
desborde_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
desborde_i_5: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cont_config_1_contNb_top is
  port (
    desborde_o : out STD_LOGIC;
    SR : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of cont_config_1_contNb_top : entity is "contNb_top";
end cont_config_1_contNb_top;

architecture STRUCTURE of cont_config_1_contNb_top is
  signal \^sr\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal ena_gen : STD_LOGIC;
  signal estadoSiguiente0 : STD_LOGIC;
  signal genEnaNb_inst_n_1 : STD_LOGIC;
  signal genEnaNb_inst_n_2 : STD_LOGIC;
begin
  SR(0) <= \^sr\(0);
contNb_inst: entity work.cont_config_1_contNb
     port map (
...
genEnaNb_inst: entity work.cont_config_1_genEnaNb
     port map (
      CO(0) => estadoSiguiente0,
      Q(2) => Q(3),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cont_config_1_cont_config_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of cont_config_1_cont_config_v1_0_S00_AXI : entity is "cont_config_v1_0_S00_AXI";
end cont_config_1_cont_config_v1_0_S00_AXI;

architecture STRUCTURE of cont_config_1_cont_config_v1_0_S00_AXI is
...
contNb_top_inst: entity work.cont_config_1_contNb_top
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cont_config_1_cont_config_v1_0 is
  port (
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_WREADY : out STD_LOGIC;
    S_AXI_ARREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of cont_config_1_cont_config_v1_0 : entity is "cont_config_v1_0";
end cont_config_1_cont_config_v1_0;

architecture STRUCTURE of cont_config_1_cont_config_v1_0 is
begin
cont_config_v1_0_S00_AXI_inst: entity work.cont_config_1_cont_config_v1_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
entity cont_config_1 is
  ...
  attribute NotValidForBitStream of cont_config_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of cont_config_1 : entity is "cont_config_1,cont_config_v1_0,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of cont_config_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of cont_config_1 : entity is "cont_config_v1_0,Vivado 2018.3";
end cont_config_1;

architecture STRUCTURE of cont_config_1 is
...
U0: entity work.cont_config_1_cont_config_v1_0
     port map (
